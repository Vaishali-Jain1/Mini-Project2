...
$finalresult="insert into user(username,totalques,answercorrect) values('','5','$result')";
...
<body>
    <div class="container text-center">
        <br><br>
        <h1 class="text-center text-success text-uppercase animateuse"> WebDevelopers's Quiz</h1>
        <br><br><br><br>
        <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
            ...
            $finalresult = " insert into usersession(username,totalques, answercorrect) values ('','5','$Resultans') ";
            $queryresult= mysqli_query($con,$finalresult); 
            // if($queryresult){
            // 	echo "successssss";
            // }
